...
export const COMPARISONS: Comparison[] = [
  {
    ...
    rows: [
      ...
      { label: "Price", koegaki: koegakiCommon.price, other: "Subscription (monthly or yearly) or a lifetime licence; see superwhisper.com for current prices." },
      ...
      { label: "Account required", koegaki: koegakiCommon.account, other: "Licence tied to an account for the paid tier." },
  ...
  },
  {
    ...
    rows: [
      ...
      { label: "Price", koegaki: koegakiCommon.price, other: "Monthly subscription, with a free tier capped at a weekly word count; see wisprflow.ai for current prices." },
      { label: "Platforms", koegaki: koegakiCommon.platforms, other: "macOS, Windows and iOS." },
      { label: "Account required", koegaki: koegakiCommon.account, other: "Yes." },
  ...
  },
  {
    ...
    rows: [
      ...
      { label: "How you trigger it", koegaki: koegakiCommon.trigger, other: "A key press toggles dictation on; it stays on until you stop it or it times out." },
      { label: "Custom vocabulary", koegaki: koegakiCommon.vocab, other: "No user-defined vocabulary for dictation." },
  ...
  },
  {
    ...
    rows: [
      ...
      { label: "Custom vocabulary", koegaki: koegakiCommon.vocab, other: "None." },
